        ...
        {mainSection !== 'home' ? <section className="panel wide">
          <div className="row-between section-head">
            <div>
              ...
              <p className="muted">{mainSection === 'single' ? lt('내 파티를 관리하고 상대 엔트리에 따라 스피드와 결정력을 계산할 수 있습니다.') : lt('포켓몬 하나만 잡고 성격/능력 포인트/샘플 기술을 빠르게 깎는 전용 화면입니다.')}</p>
            </div>
            {mainSection === 'single' ? (
