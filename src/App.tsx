          ...
          <div className="header-title-row">
            <div className="header-title-stack">
              <div>
                ...
                <p>{mainSection === 'home' ? lt('포켓몬 챔피언스 싱글 배틀에서 파티·선출·스피드·대미지를 한 번에 정리합니다.') : menuLabelForSection(mainSection, activeTab, siteLanguage)}</p>
              </div>
