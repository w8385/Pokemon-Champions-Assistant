    ...
    <div className="app-shell">
      ...
      <main className="grid">
          ...
          <div className="home-route-grid">
            <button type="button" className="home-route-card accent" onClick={() => setMainSection('single')}>
              <div className="home-route-card-copy">
                ...
                <p>{lt('내 파티를 관리하고 상대 엔트리에 따라 스피드와 결정력을 계산할 수 있습니다.')}</p>
              </div>
            </button>
        ...
        {mainSection !== 'home' ? <section className="panel wide">
          <div className="row-between section-head">
            <div>
              ...
              <p className="muted">{mainSection === 'single' ? lt('내 파티를 관리하고 상대 엔트리에 따라 스피드와 결정력을 계산할 수 있습니다.') : lt('포켓몬 하나를 기준으로 성격, 노력치, 기술을 조정하고 샘플로 저장할 수 있습니다.')}</p>
            </div>
            {mainSection === 'single' ? (
        ...
        <section className="panel wide">
          ...
          {!sampleOverviewCollapsed ? <div className="team-strip-grid sample-overview-grid">
