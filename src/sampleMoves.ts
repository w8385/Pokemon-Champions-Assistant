...
export const sampleMoves: SampleMoveEntry[] = [
  {
    ...
    options: ['유턴', '트리플악셀'],
    utility: ['앵콜'],
    notes: ['포챔스 통계 프록시에서는 인파이트/유턴/트리플악셀 비중이 높음', '냉동펀치/번개펀치는 저우선 커버 분기로 제외'],
  },
  {
    key: 'mega-delphox',
    source: {
    ...
    options: ['오버히트', '사이코쇼크'],
    utility: ['앵콜'],
    notes: ['포챔스 통계 프록시에서는 화염방사/사이코키네시스/매지컬샤인이 상위', '앵콜 여부가 샘플 분기점', '대타출동/명상은 저우선 분기로 제외'],
  },
  {
    key: 'garchomp',
    source: {
    ...
    options: ['암석봉인', '스케일샷'],
    utility: ['스텔스록'],
    notes: ['포챔스 통계 기준 지진/역린 뒤로 스텔스록, 암석봉인 비중이 높음', '독찌르기/칼춤은 저우선 분기로 제외'],
  },
  {
    key: 'toxapex',
    source: {
    ...
    options: ['맹독', '흑안개'],
    utility: ['독압정'],
    notes: ['포챔스 통계 기준 맹독/흑안개 축 우선', '토치카/냉동빔은 저우선 후보로 제외'],
  },
  {
    key: 'corviknight',
    source: {
    ...
    options: ['철벽', '유턴'],
    utility: ['브레이브버드'],
    notes: ['포챔스 통계 기준 날개쉬기/바디프레스/철벽 축 비중이 높음', '아이언헤드/도발/벌크업은 저빈도 분기로 제외'],
  },
  {
    key: 'kingambit',
    source: {
    ...
    options: ['아이언헤드', '로우킥'],
    utility: ['칼춤', '도발'],
    notes: ['포챔스 통계 기준 도각참 누락은 오류로 보고 바로 보강', '기습/칼춤 확인이 우선', '메탈버스트는 실전 추적 우선도 낮아 제외'],
  },
  {
    key: 'rotom',
    source: {
    ...
    options: ['10만볼트', '트릭'],
    utility: ['도깨비불'],
    notes: ['트릭/상태이상기 보유 확인', '악의파동/전기자석파는 저우선 분기로 제외'],
  },
  {
    key: 'primarina',
    source: {
    ...
    options: ['하이퍼보이스', '에너지볼'],
    utility: ['명상'],
    notes: ['앵콜/명상 여부로 운영 달라짐', '냉동빔/앵콜은 저우선 분기로 제외'],
  },
  {
    key: 'dragapult',
    source: {
    ...
    options: ['용성군', '유턴'],
    utility: ['도깨비불'],
    notes: ['물리/특수/서포트 분기 추적', '불대문자/전기자석파는 보조 저빈도 분기로 제외'],
  },
  {
    key: 'mimikyu',
    source: {
    ...
    options: ['야습', '우드해머'],
    utility: ['칼춤'],
    notes: ['칼춤형인지 유틸형인지 확인', '도깨비불/대타출동은 저우선 분기로 제외'],
  },
  {
    key: 'meowscarada',
    source: {
    ...
    options: ['유턴', '치근거리기'],
    utility: ['압정뿌리기'],
    notes: ['유턴/압정 여부 중요', '로우킥/도발은 저우선 분기로 제외'],
  },
]
